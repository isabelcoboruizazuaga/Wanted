...
{
	[ExecuteInEditMode]
	public class DfaultsController1 : MonoBehaviour
	{
		public DfaultsConfig dfaultsConfig;
		public Material dfaultsMaterial;
        public DfaultsConfig[] configList;
		...
		private static void SetupMaterial(DfaultsController1 _this)
		{
		...
		private static void UpdateProperties(DfaultsController1 _this)
		{
			// PerRenderedData.
			for (int i = 0; i < _this.renderers.Length; i++)
		...
		private static bool SanityChecks(DfaultsController1 _this)
		{
		...
		private static Renderer[] GetRenderers(DfaultsController1 _this)
		{
			Renderer[] result;
